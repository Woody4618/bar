 ...
 * IDL can be found at `target/idl/let_me_buy.json`.
 */
export type LetMeBuy = {
  ...
  instructions: [
    ...
    {
      name: "deleteProduct";
      discriminator: [173, 212, 141, 230, 33, 82, 166, 25];
      accounts: [
        {
          name: "receipts";
          writable: true;
    ...
    {
      name: "deleteStore";
      discriminator: [150, 83, 75, 192, 195, 29, 178, 183];
      accounts: [
        {
          name: "receipts";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [112, 46, 230, 68, 152, 97, 194, 62];
      accounts: [
        {
          name: "receipts";
          writable: true;
